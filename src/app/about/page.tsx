  ...
  return (
    <>
      <section className="bg-secondary py-20">
        <div className="container mx-auto px-4 text-center animate-in fade-in slide-in-from-top-12 duration-500">
          ...
          <div className="grid md:grid-cols-5 gap-12 items-center">
            <div className="md:col-span-2 animate-in fade-in slide-in-from-left-12 duration-500">
              <Image
                ...
                data-ai-hint="futuristic portrait woman"
              />
            </div>
            <div className="md:col-span-3 animate-in fade-in slide-in-from-right-12 duration-500">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <Card className="hover:scale-105 hover:border-primary/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom-12 duration-500">
              <CardHeader>
            ...
            <Card className="hover:scale-105 hover:border-primary/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom-12 duration-500 [animation-delay:150ms]">
              <CardHeader>
                <div className="mx-auto bg-accent/10 rounded-full p-3 w-fit">
            ...
            <Card className="hover:scale-105 hover:border-primary/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom-12 duration-500 [animation-delay:300ms]">
              <CardHeader>
                <div className="mx-auto bg-accent/10 rounded-full p-3 w-fit">
